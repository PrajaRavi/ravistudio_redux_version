      ...
      <div className='w-full h-full mx-auto'>
         {songs?.length!=0?songs?.map((song,index) => (
          <motion.div
            ...
            className={SongData[currsongindex]?._id!=song?._id?"relative flex items-center gap-4 z-10 w-full bg-white/5 border  border-black/10 backdrop-blur-xl my-2 rounded-xl p-3":"relative flex items-center gap-4 z-10 w-full bg-blue-300/50 border  border-black/10 backdrop-blur-xl rounded-xl p-3"}
